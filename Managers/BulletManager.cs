...
public class BulletManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        InitializeBulletPool(BulletTypes.BulletType.Normal, normalBulletPrefab, 50);
        InitializeBulletPool(BulletTypes.BulletType.Repeater, repeaterBulletPrefab, 50);
        InitializeBulletPool(BulletTypes.BulletType.LongRange, longRangeBulletPrefab, 50);
        InitializeBulletPool(BulletTypes.BulletType.Spreader, spreaderBulletPrefab, 50);
        InitializeBulletPool(BulletTypes.BulletType.HomingMissile, homingMissilePrefab, 50);
    }
