...
public class LongRangePowerUpBehavior : MonoBehaviour
{
    public float distanceIncrease = 5f; // Increase in bullet distance.
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.CompareTag("Player"))
        {
            ...
            if (playerAmmo != null)
            {
                ...
                playerAmmo.ActivateLongRangePowerUp(distanceIncrease);
